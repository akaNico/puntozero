 ...
 */
 ...
 <div id="content" class="row style-development">
    ...
    <img src="<?php echo get_bloginfo('template_directory');?>/images/prototypes-bottom-left.png" class="style-development-bottom-left" alt="style-development-bottom-left" />
    <img src="<?php echo get_bloginfo('template_directory');?>/images/prototypes-bottom-right.png" class="style-development-bottom-right" alt="style-development-bottom-right" />
