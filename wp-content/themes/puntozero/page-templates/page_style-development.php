<?php
/**
 * Template Name: Style Development
 *
 * @package WordPress
 ...
 */
 ...
 <div id="content" class="row style-development">
    ...
    <img src="<?php echo get_bloginfo('template_directory');?>/images/style-development-top-right.png" class="style-development-top-right" alt="style-development-top-right" />
    <img src="<?php echo get_bloginfo('template_directory');?>/images/style-development-bottom-left.png" class="style-development-bottom-left" alt="style-development-bottom-left" />
